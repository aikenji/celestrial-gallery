(() => {
    ...
    const elements = {
        ...
        sliderAlt: document.getElementById('slider-alt'),
        valAlt: document.getElementById('val-alt'),
        filterMag: document.getElementById('filter-mag'),
        sliderMag: document.getElementById('slider-mag'),
        valMag: document.getElementById('val-mag'),
        filterRa: document.getElementById('filter-ra'),
        sliderRa: document.getElementById('slider-ra'),
        valRa: document.getElementById('val-ra'),
        sortMagBtn: document.getElementById('sort-mag'),
        sortAltBtn: document.getElementById('sort-alt'),
